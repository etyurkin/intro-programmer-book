...
Спрингу сюда нельзя. Кто пролез — выгнать. Здесь консоль, файлы, текст, который притворяется данными, и одно письмо в сеть без фреймворка.
...
Сохранение в две строки — человеческое, не JSON пока:
...
Сломай нарочно `set`: забудь верхнюю границу. Введи 10000. Посмотри, как глючит дашборд. Верни границу. Вот лабораторная работа. Отчёт — git diff, не эссе.
