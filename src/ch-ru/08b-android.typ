...
#sunday[
  Добавь кнопку `×` и `÷`, если вдруг ещё нет. Потом тему потемнее. Потом «а давай это будет калькулятор станции: ватты и кислород». Сорвёшься в игру — нормально. Так Барски и задумал, только у него орки, у нас орбита.
]
